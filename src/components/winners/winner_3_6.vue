  ...
  <div class="winner">
    ...
    <div class="detail-winner" :class="!expanded ? 'detail-winner-hidden' : ''">
      <div class="detail-item">
        ...
        <div class="detail-content">Freaks (Team)</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Team members:</div>
        <div class="detail-content">FreakyWaves, rAmme, OrpLefotrak, Panddiee</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World:</div>
        <div class="detail-content">Eternea8</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Duration:</div>
        <div class="detail-content">10 Days</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">End Date:</div>
        <div class="detail-content">21.06.2020</div>
      </div>
      <div class="detail-item">
