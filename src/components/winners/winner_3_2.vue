  ...
  <div class="winner">
    ...
    <div class="detail-winner" :class="!expanded ? 'detail-winner-hidden' : ''">
      <div class="detail-item">
        ...
        <div class="detail-content">Crystalized (Team)</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Team members:</div>
        <div class="detail-content">Mephisto, rfctgv, Milomachi, Leaffox14</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World:</div>
        <div class="detail-content">Zeduvis5</div>
      </div>
      <div class="detail-item">
      ...
      <div class="detail-item">
        ...
        <div class="detail-content">14.06.2020</div>
      </div>
      <div class="detail-item">
