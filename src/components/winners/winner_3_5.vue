  ...
  <div class="winner">
    ...
    <div class="detail-winner" :class="!expanded ? 'detail-winner-hidden' : ''">
      <div class="detail-item">
        ...
        <div class="detail-content">Metal Gaer (Team)</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Team members:</div>
        <div class="detail-content">SnakeEyes, Tiberim, Charka, Anno</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World:</div>
        <div class="detail-content">Eternea9</div>
      </div>
      <div class="detail-item">
      ...
      <div class="detail-item">
        ...
        <div class="detail-content">20.06.2020</div>
      </div>
      <div class="detail-item">
