  ...
  <div class="winner">
    ...
    <div class="detail-winner" :class="!expanded ? 'detail-winner-hidden' : ''">
      <div class="detail-item">
        ...
        <div class="detail-content">Fallen Gods (Team)</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Team members:</div>
        <div class="detail-content">Nemesis, Yamil, arccy, Icon</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World:</div>
        <div class="detail-content">Eternea7</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Duration:</div>
        <div class="detail-content">7 Days</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">End Date:</div>
        <div class="detail-content">16.06.2020</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World Type:</div>
        <div class="detail-content">Beginner</div>
      </div>
    </div>
  </div>
</template>
