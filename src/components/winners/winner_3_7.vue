  ...
  <div class="winner">
    ...
    <div class="detail-winner" :class="!expanded ? 'detail-winner-hidden' : ''">
      <div class="detail-item">
        ...
        <div class="detail-content">Papaya (Team)</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Team members:</div>
        <div class="detail-content">Yomap23, Sysilus, BepisDog, Charka</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">World:</div>
        <div class="detail-content">Igris10</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">Duration:</div>
        <div class="detail-content">11 Days</div>
      </div>
      <div class="detail-item">
        <div class="detail-label">End Date:</div>
        <div class="detail-content">27.06.2020</div>
      </div>
      <div class="detail-item">
